...
Tcn = 0.313889
Tc = 92
d_thick = 0.142345 #junction thickness in nm
Bc2 = Bc20*(1-T/Tc)**sw
...
ws = 2.92 #in units of sqrt(phi_0) - 2.2 is 100 nm
B0 = 1000*(1/(ws**2))*(c0**(1/c1)) #in mT

M_nu = 1.2597/(Bc2/(Bc20*(1-(T/Tc)**2))) #calculate m / upsilon ratio at given temp
...
No_elements = 71 #number of elements across width of tape

Bext = 0.01 #Applied field in mT
Current = 0
